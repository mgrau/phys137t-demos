<script lang="ts">
  ...
  function draw(
    ...
    drawCylinder(ctx, cx, cy + capDist, capRX, capH, capPersp);
    ...
    b194.addColorStop(0, `rgba(129,140,248,0)`);
    b194.addColorStop(0.2, `rgba(129,140,248,${beamAlpha * 0.6})`);
    b194.addColorStop(0.5, `rgba(129,140,248,${beamAlpha})`);
    b194.addColorStop(0.8, `rgba(129,140,248,${beamAlpha * 0.6})`);
    b194.addColorStop(1, `rgba(129,140,248,0)`);
    ctx.fillStyle = b194;
    ...
    if (ion === 'pulsing') {
      ...
      b282.addColorStop(0, 'rgba(192,132,252,0)');
      b282.addColorStop(0.25, 'rgba(192,132,252,0.35)');
      b282.addColorStop(0.5, 'rgba(192,132,252,0.55)');
      b282.addColorStop(0.75, 'rgba(192,132,252,0.35)');
      b282.addColorStop(1, 'rgba(192,132,252,0)');
      ctx.fillStyle = b282;
    ...
    if (ion === 'bright') {
      ...
      g1.addColorStop(0, 'rgba(129,140,248,0.35)');
      g1.addColorStop(1, 'rgba(129,140,248,0)');
      ctx.fillStyle = g1;
      ctx.fillRect(cx - ionR * 6, cy - ionR * 6, ionR * 12, ionR * 12);
      for (const p of PHOTONS) {
        const px = cx + Math.cos(p.angle) * ionR * p.dist * 12;
        const py = cy + Math.sin(p.angle) * ionR * p.dist * 10;
      ...
      g2.addColorStop(0.4, 'rgba(170,180,255,0.5)');
      ...
      gp.addColorStop(0, 'rgba(192,132,252,0.5)');
      gp.addColorStop(1, 'rgba(192,132,252,0)');
      ctx.fillStyle = gp;
      ctx.beginPath();
    ...
    ringGrad.addColorStop(0, '#1E3044');
    ringGrad.addColorStop(0.2, '#4A6478');
    ringGrad.addColorStop(0.4, '#6A8498');
    ringGrad.addColorStop(0.6, '#6A8498');
    ringGrad.addColorStop(0.8, '#4A6478');
    ringGrad.addColorStop(1, '#1E3044');
  ...
  function drawCylinder(
    ...
    bodyGrad.addColorStop(0, '#1A2C3E');
    bodyGrad.addColorStop(0.3, '#4A6070');
    bodyGrad.addColorStop(0.5, '#5A7080');
    bodyGrad.addColorStop(0.7, '#4A6070');
    bodyGrad.addColorStop(1, '#1A2C3E');
    ...
    faceGrad.addColorStop(0, '#4A6478');
    faceGrad.addColorStop(1, '#2A3E52');
